...
const ProductDescription = () => {
  ...
  let a;
  const [orderedProduct, setorderedProduct] = useState(false); //true if we want to display the "write a review" option. false otherwise
          ...
          <div className="row">
            ...
            <div className="col-6">
              ...
              <div className="other-product-images d-flex flex-wrap gap-15">
                <div>
                  <img
                    src="https://daveceddia.com/images/useState-hook@2x.png"
                    className="img-fluid"
                    alt=""
                  />
                </div>
        ...
        <div className="container-xxl">
          <div className="row">
            <div className="col-12">
              ...
              <div className="review-inner-wrapper  review-scroll">
